...
//nolint:dupl // table-driven CRUD test shape intentionally mirrors WorkflowStepService tests (see PATTERNS.md)
func TestWorkflowStepTemplateService_Create(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			svc := NewWorkflowStepTemplateService(logger.NewNoOp(), repo)
