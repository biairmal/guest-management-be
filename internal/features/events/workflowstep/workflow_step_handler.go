...
// Handler exposes HTTP handlers for event-scoped workflow step CRUD.
type Handler struct {
	service   Service
	validator validation.Validator
}

// NewHandler returns a Handler that uses the given
...
//	@Success		200			{object}	common.PageResponse[workflowstep.WorkflowStep]
...
//	@Success		200			{object}	workflowstep.WorkflowStep
...
//	@Produce		json
//	@Param			event_id	path		string							true	"Event UUID"
//	@Param			body		body		workflowstep.CreateWorkflowStepInput	true	"Workflow step payload"
//	@Success		201			{object}	workflowstep.WorkflowStep
...
//	@Param			event_id	path		string							true	"Event UUID"
//	@Param			id			path		string							true	"Workflow step UUID"
//	@Param			body		body		workflowstep.UpdateWorkflowStepInput	true	"Fields to update"
//	@Success		200			{object}	workflowstep.WorkflowStep
...
//	@Produce		json
//	@Param			event_id	path		string							true	"Event UUID"
//	@Param			body		body		[]workflowstep.SyncWorkflowStepInput	true	"Full desired list of workflow steps"
//	@Success		200			{array}		workflowstep.WorkflowStep
...
func (h *Handler) Sync(r *http.Request) (any, error) {
	eventID, err := eventIDFromPath(r)
	if err != nil {
		return nil, err
	}
