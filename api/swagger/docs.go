...
const docTemplate = `{
    ...
    "paths": {
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/internal_features_events_category.Detail"
                        }
                    },
                    "400": {
                        "description": "Invalid request body or validation error (meta.fields keyed by JSON path)",
                        "schema": {
                            "type": "object"
                        }
                    },
                    "403": {
                        "description": "Missing manage_events, or app category by a non-platform tenant",
                        "schema": {
                            "type": "object"
                        }
                    },
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_features_events_category.ReplaceInput"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid ID, request body, or validation error (meta.fields keyed by JSON path)",
                        "schema": {
                            "type": "object"
                        }
                    },
                    ...
                    "409": {
                        "description": "Stale template_version (meta.template_version is the current one)",
                        "schema": {
                            "type": "object"
                        }
                    },
        ...
        "/api/v1/events/{event_id}/guests": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "string",
                        "description": "Filter by name — exact, or partial via name=value;like",
                        "name": "name",
                        "in": "query"
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/dto.PageResponse-internal_features_guests_Guest"
                        }
                    },
                    "400": {
                    ...
                    "403": {
                        "description": "Missing manage_guests permission",
                        "schema": {
                            "type": "object"
                        }
                    },
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_features_guests.CreateGuestInput"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/internal_features_guests.Guest"
                        }
                    },
                    "400": {
                        "description": "Invalid request body or ticket type not on this event",
                        "schema": {
                            "type": "object"
                        }
                    },
        ...
        "/api/v1/events/{event_id}/guests/{id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_features_guests.UpdateGuestInput"
                        }
                    }
                ],
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid ID, request body, or ticket type not on this event",
                        "schema": {
                            "type": "object"
                        }
                    },
        ...
        "/api/v1/events/{event_id}/guests/{id}/invitation": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/internal_features_guests.SendInvitationOutput"
                        }
                    },
                    "400": {
                        "description": "No ticket type assigned",
                        "schema": {
                            "type": "object"
                        }
                    },
        ...
        "/api/v1/events/{event_id}/ticket-types": {
            ...
            "post": {
                ...
                "responses": {
                    ...
                    "409": {
                        "description": "Ticket type name already exists for this event",
                        "schema": {
                            "type": "object"
                        }
                    },
        ...
        "/api/v1/events/{event_id}/ticket-types/{id}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
        ...
        "/api/v1/events/{event_id}/ticket-types/{id}/workflow-steps": {
            "put": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    {
                        "description": "Full desired set of workflow step IDs",
                        "name": "body",
                        "in": "body",
                        "required": true,
                        "schema": {
                ...
                "responses": {
                    ...
                    "400": {
                        "description": "Invalid request body, ID, or a workflow_step_id not belonging to this event",
                        "schema": {
                            "type": "object"
                        }
                    },
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/internal_features_guests.RSVPInput"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "dto.PageResponse-internal_features_guests_Guest": {
            "type": "object",
            "properties": {
                "has_next": {
                    "type": "boolean"
        ...
        "internal_features_events_category.CreateInput": {
            ...
            "properties": {
                ...
                "ticket_types": {
                    ...
                    "maxItems": 100,
                    "items": {
                        "$ref": "#/definitions/internal_features_events_category.TicketTypeInput"
                    }
                },
                "workflow_steps": {
                    "type": "array",
                    "maxItems": 100,
                    "items": {
                        "$ref": "#/definitions/internal_features_events_category.WorkflowStepInput"
                    }
                }
            }
        },
        "internal_features_events_category.Detail": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
                ...
                "ticket_types": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_features_events_category.TicketTypeView"
                    }
                },
                "updated_at": {
                    "type": "string"
                ...
                "workflow_steps": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/internal_features_events_category.WorkflowStepView"
                    }
                }
            }
        },
        ...
        "internal_features_events_category.ReplaceInput": {
            "type": "object",
            "required": [
                "name",
                "template_version"
        ...
        "internal_features_events_category.TicketTypeInput": {
            "type": "object",
            "required": [
                "name"
            ],
        ...
        "internal_features_events_category.TicketTypeView": {
            "type": "object",
            "properties": {
                "id": {
                    "type": "string"
        ...
        "internal_features_events_category.WorkflowStepInput": {
            "type": "object",
            "required": [
                "name"
            ],
        ...
        "internal_features_events_category.WorkflowStepView": {
            "type": "object",
            "properties": {
                "allows_multiple": {
                    "type": "boolean"
        ...
        "internal_features_events_event.Event": {
            ...
            "properties": {
                ...
                "category_template_version": {
                    "description": "CategoryTemplateVersion is the category template version this event's\nworkflow steps and ticket types were copied from (B15). Set by Create.",
                    "type": "integer"
                },
                "created_at": {
                    "type": "string"
        ...
        "internal_features_guests.CreateGuestInput": {
            "type": "object",
            "required": [
                "email",
                "name"
        ...
        "internal_features_guests.Guest": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
                ...
                "ticket": {
                    "$ref": "#/definitions/internal_features_guests.Ticket"
                },
                "ticket_id": {
                    "type": "string"
                },
        ...
        "internal_features_guests.RSVPInput": {
            "type": "object",
            "required": [
                "status"
            ],
        ...
        "internal_features_guests.SendInvitationOutput": {
            "type": "object",
            "properties": {
                "guest": {
                    "$ref": "#/definitions/internal_features_guests.Guest"
        ...
        "internal_features_guests.Ticket": {
            "type": "object",
            "properties": {
                "created_at": {
                    "type": "string"
        ...
        "internal_features_guests.UpdateGuestInput": {
            "type": "object",
            "properties": {
                "email": {
                    "type": "string"
